 ...
 */
public class FavouriteBookEndpoint {

    private Integer itemCount;
    private Integer offset;
    private Integer limit;
    private Integer max_limit;
    private List<FavouriteBook> results;
    ...
    public List<FavouriteBook> getResults() {
        return results;
    }

    public void setResults(List<FavouriteBook> results) {
